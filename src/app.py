...
activities = {
    ...
    "Track and Field": {
        "description": "Develop speed, endurance, and athletic skills in running and field events",
    ...
    "Math Club": {
        "description": "Solve complex math problems and prepare for mathematics competitions",
